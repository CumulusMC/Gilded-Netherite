...
public class RegisterItems {
    ...
    public static final Item PLATED_NETHERITE = new GildedNetheriteItem(new Item.Settings().group(GildedNetherite.GILDED_NETHERITE_GROUP));
    ...
    public static void register() {
        ...
        Registry.register(Registry.ITEM, new Identifier("gildednetherite", "plated_netherite"), PLATED_NETHERITE);
